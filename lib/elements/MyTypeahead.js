...
var MyTypeahead = /*#__PURE__*/function (_Component) {
  ...
  _createClass(MyTypeahead, [{
    ...
    value: function handleOnChange(event, refer) {
      if (event[0]) this.props.handleOnChange(event[0], refer); // this.setState({selected : selected})
    ...
    value: function render() {
      ...
      }, label), !hidden && /*#__PURE__*/_react.default.createElement("div", {
        onChange: function onChange(event) {
          return _this2.handleOnChange(event, refer);
        }
      }, /*#__PURE__*/_react.default.createElement(_reactBootstrapTypeahead.Typeahead, {
        id: refer,
