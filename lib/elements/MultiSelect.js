...
var MultiSelect = /*#__PURE__*/function (_Component) {
  ...
  _createClass(MultiSelect, [{
    ...
    value: function onSelect(selectedList, selectedItem) {
      var key = !!this.props.optionKey ? this.props.optionKey : '_id';
    ...
    value: function onRemove(selectedList, removedItem) {
      var index = this.state.value.indexOf(removedItem.id);
    ...
    value: function render() {
      ...
      }, label), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_multiselectReactDropdown.Multiselect, {
