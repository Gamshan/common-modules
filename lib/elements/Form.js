...
var Form = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function handleOnChange(value, refer) {
      ...
      req[refer] = value;
      this.props.schema.map(function (element) {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          req = _this$props.req;
      return /*#__PURE__*/_react.default.createElement("div", null, schema.map(function (element) {
        if (!_this2.isHiddenElement(element)) return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, element.type === 'SELECT' && /*#__PURE__*/_react.default.createElement(_Select.default, _extends({}, element, {
          items: _this2.getItemsList(element),
