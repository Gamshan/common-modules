...
var Form = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function componentWillReceiveProps(nextProps, nextContext) {
      ...
      if (nextProps.req) {
        if (nextProps.schema && nextProps.schema.length > 0) nextProps.schema.map(function (element) {
          _this2.getItemsList(element);
        });
        this.setState({
          req: nextProps.req
        });
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, schema.map(function (element) {
        if (!_this4.isHiddenElement(element)) return /*#__PURE__*/_react.default.createElement("label", {
          ...
          onFocus: _this4.getItemsList.bind(_this4, element)
