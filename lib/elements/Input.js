...
var Input = /*#__PURE__*/function (_Component) {
  ...
  function Input(props) {
    ...
    if (props.value || props.value === 0) _this.state.value = props.value;
    return _this;
  }

  _createClass(Input, [{
    key: "componentWillReceiveProps",
    value: function componentWillReceiveProps(nextProps, nextContext) {// console.log('nextProps',nextProps.value)
    ...
    value: function render() {
      ...
      }, inputType !== 'textArea' && /*#__PURE__*/_react.default.createElement("input", {
